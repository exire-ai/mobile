...
export default class GetStarted extends React.Component {
    constructor(props) {
        ...
        this.state = {
            imageHolder: [
                require('../assets/getStarted0.jpg'),
                require('../assets/getStarted1.jpg')
            ],
            currentIndex: 0
        };
        setInterval(() => {
            this.setState({
                currentIndex:
                    this.state.currentIndex == this.state.imageHolder.length - 1
                        ? 0
    ...
    render() {
        return (
            <ImageBackground
                source={this.state.imageHolder[this.state.currentIndex]}
                style={{ width: '100%', height: '100%' }}
            >
                <View style={getStartedStyles.container}>
                    <Text style={getStartedStyles.headerText}>exire</Text>
                    <Text style={getStartedStyles.subHeaderText}>
                    ...
                    <View style={getStartedStyles.bottom}>
                        ...
                        >
                            <Text style={getStartedStyles.buttonText}>
                                Get Started
                            </Text>
                        </TouchableOpacity>
                    </View>
