                    ...
                    renderItem={({ item, index }) => (
                        <Chat
                            ...
                            select={() => {
                                ...
                                this.setState({
                                    selected:
                                        _.get(this.state.selected, 'chatID') !==
                                            item.chatID && item
                                });
                            }}
                            imgURL={
                ...
                {this.state.onboard != 'false' ? (
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                This is where you can talk to friends or your
                                concierge, Emma, to create plans. Get started by
                                entering a conversation or find something on
                                discover!
                            </Text>
                            <TouchableOpacity
                                activeOpacity={0.9}
