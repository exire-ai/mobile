const users = {
    ...
    updateName: function (userID, name, callback) {
        fetch('http://api.exire.ai/users/updateName/' + userID + '/' + name, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    updateCategories: function (userID, categories, callback) {
        fetch('http://api.exire.ai/users/updateCategories/' + userID, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    updateChat: function (userID, chatID, callback) {
        fetch('http://api.exire.ai/users/updateChat/' + userID + '/' + chatID, {
            method: 'GET',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    updateToken: function (userID, newToken, callback) {
        fetch(
            'http://api.exire.ai/users/updateToken/' + userID + '/' + newToken,
            {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
    ...
    doesNumberExist: function (number, callback) {
        fetch('http://api.exire.ai/users/doesNumberExist/' + number, {
            method: 'GET',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    getWelcomeMessage: function (userID, callback) {
        fetch('http://api.exire.ai/users/getWelcomeMessage/' + userID, {
            method: 'GET',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    sendTextMsg: function (number, message, callback) {
        fetch('http://api.exire.ai/external/sendTextMsg/' + number, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    addFriend: function (userID, otherUserID, callback) {
        fetch(
            'http://api.exire.ai/users/addFriend/' + userID + '/' + otherUserID,
            {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
    ...
    addPlan: function (userID, planID, callback) {
        fetch('http://api.exire.ai/users/addPlan/' + userID + '/' + planID, {
            method: 'GET',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    getPlans: function (userID, callback) {
        fetch(
            'http://api.exire.ai/users/getPlans/' + userID + '?populate=true',
            {
                method: 'GET',
                headers: {
                    Accept: 'application/json',
    ...
    updateProfileImg: function (userID, profileImg, callback) {
        fetch('http://api.exire.ai/users/updateProfileImg/' + userID, {
            method: 'POST',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
